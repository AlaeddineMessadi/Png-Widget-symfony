...
use PngWidgetBundle\Form\UserType;
...
class UserController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('PngWidgetBundle:User')->findAll();
     ...
     * @Method("POST")
     * @Template("PngWidgetBundle:User:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('PngWidgetBundle:User')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("PngWidgetBundle:User:edit.html.twig")
     */
